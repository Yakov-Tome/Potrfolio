...
export const skillGroups = [
  {
    ...
    // nodejs2 (1085:5217), the solid hexagon — not the wordmark at 867:18823.
  ...
  },
  {
    ...
    //
    // Exchange and Autopilot are NOT here. Neither exists in any of those six
    // files — the closest to Exchange is an "Exchange Access" shield-and-padlock
    // that means conditional access, not the product. Naming a technology with
    // somebody else's logo is worse than leaving it out.
    items: [
...
const en = {
  ...
  stack: {
    ...
    groups: { development: "Development", microsoftCloud: "Microsoft Cloud" },
  },
...
const he = {
  ...
  stack: {
    ...
    flip: "לחץ להיפוך",
    flipBack: "לחץ לחזרה",
    groups: { development: "פיתוח", microsoftCloud: "ענן Microsoft" },
  },
