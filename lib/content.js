...
/* -------------------------------------------------------------- experience */
// `start` is the sortable form of `period`'s first date: the CV section orders
// its slots by it and prints its year as the slot's numeral, so it has to be
// machine-readable rather than parsed back out of the display string.
export const experience = [
  { id: "cloud247", company: "Cloud247", period: "Feb 2024 – Present", start: "2024-02" },
  { id: "primo", company: "Primo Water Corporation", period: "Jun 2021 – Feb 2024", start: "2021-06" },
  { id: "lab", company: "Self-employed", period: "Jun 2017 – Jun 2021", start: "2017-06" },
  { id: "it", company: "Center District", period: "Oct 2006 – Oct 2009", start: "2006-10" },
];
