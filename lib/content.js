  ...
  experience: {
    ...
    items: {
      ...
      primo: {
        ...
        detail:
          "End-to-end IT support for more than 300 employees across Windows and macOS environments. Managing users, permissions and group policy in Active Directory, and running a global SCCM environment for software and operating system distribution. Alongside that, leading the support team in Israel — onboarding, training and mentoring new staff.",
      },
    },
  },
  ...
  experience: {
    ...
    items: {
      ...
      primo: {
        ...
        detail:
          "מתן תמיכת IT מקצה לקצה ליותר מ־300 עובדים בסביבות Windows ו־macOS. ניהול משתמשים, הרשאות ומדיניות קבוצתית ב־Active Directory, וניהול סביבת SCCM גלובלית להפצת תוכנות ומערכות הפעלה. בנוסף, הובלת צוות התמיכה בישראל, כולל קליטה, הכשרה וליווי מקצועי של עובדים חדשים.",
      },
    },
  },
